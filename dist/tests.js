...
qunit_1.test("Curly attributes", function (assert) {
...
qunit_1.test("Curlies inside quoted attributes", function (assert) {
    assert.tree("<div disabled=\"{{disabled}}\"></div>", hbs_parser_next_1.b.startTag({
        name: "div",
        attrs: [
            hbs_parser_next_1.b.sp,
...
qunit_1.test("Arguments", function (assert) {
    assert.tree("<div @disabled=\"{{disabled}}\"></div>", hbs_parser_next_1.b.startTag({
        name: "div",
        attrs: [
            hbs_parser_next_1.b.sp,
...
qunit_1.test("Modifiers", function (assert) {
...
qunit_1.assert.tree = function (source) {
    ...
    var _a = hbs_parser_next_1.b.root(expected), expectedRoot = _a.root, expectedSource = _a.source;
    var expectedString = hbs_parser_next_1.serializeRoot(expectedRoot, expectedSource);
    if (tree.kind === "err") {
