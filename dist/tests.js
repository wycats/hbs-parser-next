...
__webpack_require__(/*! ./parser/index */ "./tests/parser/index.ts");
...
qunit_1.test("parsing text", assert => {
    let tree = hbs_parser_next_1.b.root(hbs_parser_next_1.b.text("hello"));
    let result = hbs_parser_next_1.parse(tree.root, tree.source);
    assert.deepEqual(result, {
        type: hbs_parser_next_1.ast.NodeType.Root,
        span: { start: 0, end: 5 },
        children: [
            {
                type: hbs_parser_next_1.ast.NodeType.Text,
                span: { start: 0, end: 5 },
            },
        ],
    });
...
Object.defineProperty(exports, "__esModule", { value: true });
__webpack_require__(/*! ./html */ "./tests/parser/html.ts");
...
qunit_1.test("two interpolations next to each other", assert => {
    assert.tree("{{id.with.path some named=args other=named.args}}{{some.stuff}}", hbs_parser_next_1.b.interpolate(hbs_parser_next_1.b.id("id"), hbs_parser_next_1.b.dot, hbs_parser_next_1.b.id("with"), hbs_parser_next_1.b.dot, hbs_parser_next_1.b.id("path"), hbs_parser_next_1.b.sp, hbs_parser_next_1.b.id("some"), hbs_parser_next_1.b.sp, hbs_parser_next_1.b.id("named"), hbs_parser_next_1.b.eq, hbs_parser_next_1.b.id("args"), hbs_parser_next_1.b.sp, hbs_parser_next_1.b.id("other"), hbs_parser_next_1.b.eq, hbs_parser_next_1.b.id("named"), hbs_parser_next_1.b.dot, hbs_parser_next_1.b.id("args")), hbs_parser_next_1.b.interpolate(hbs_parser_next_1.b.id("some"), hbs_parser_next_1.b.dot, hbs_parser_next_1.b.id("stuff")));
});
