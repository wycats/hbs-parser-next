...
var LOGGER = new hbs_parser_next_1.Logger(qunit_1.config.logging || false);
qunit_1.module("[combinators] tag");
qunit_1.test("match: one character tag", function (assert) {
    var input = hbs_parser_next_1.Snippet.input("hello world", LOGGER);
    var _a = helpers_1.unwrap(input.invoke(hbs_parser_next_1.combinators.tag("h"), input)), next = _a[0], fragment = _a[1];
...
qunit_1.test("match: multi-character tag", function (assert) {
    var input = hbs_parser_next_1.Snippet.input("hello world", LOGGER);
    var _a = helpers_1.unwrap(input.invoke(hbs_parser_next_1.combinators.tag("hello"), input)), next = _a[0], fragment = _a[1];
...
qunit_1.test("mismatch: multi-character tag", function (assert) {
    var input = hbs_parser_next_1.Snippet.input("hello world", LOGGER);
    var next = input.invoke(hbs_parser_next_1.combinators.tag("holla"), input);
    helpers_1.eqError(next, hbs_parser_next_1.err(input, "tag"));
});
qunit_1.test("mismatch: not at 0 offset", function (assert) {
    var input = hbs_parser_next_1.Snippet.input("hello world", LOGGER);
    var next = helpers_1.unwrap(input.invoke(hbs_parser_next_1.combinators.tag("hello "), input))[0];
    var mismatch = next.invoke(hbs_parser_next_1.combinators.tag("woold"), next);
...
qunit_1.test("match: skipping a chunk of characters", function (assert) {
    var input = hbs_parser_next_1.Snippet.input("hello world", LOGGER);
    var _a = helpers_1.unwrap(input.invoke(hbs_parser_next_1.combinators.takeUntil("world"), input)), next = _a[0], match = _a[1];
...
qunit_1.test("match: skipping zero characters", function (assert) {
    var input = hbs_parser_next_1.Snippet.input("hello world", LOGGER);
    var _a = helpers_1.unwrap(input.invoke(hbs_parser_next_1.combinators.takeUntil("hello"), input)), next = _a[0], match = _a[1];
...
qunit_1.test("match: skipping until the last character", function (assert) {
    var input = hbs_parser_next_1.Snippet.input("hello world", LOGGER);
    var _a = helpers_1.unwrap(input.invoke(hbs_parser_next_1.combinators.takeUntil("d"), input)), next = _a[0], match = _a[1];
...
qunit_1.test("mismatch: no match before the end", function (assert) {
    var input = hbs_parser_next_1.Snippet.input("hello world", LOGGER);
    var _a = helpers_1.unwrap(input.invoke(hbs_parser_next_1.combinators.takeUntil("cruel"), input)), next = _a[0], match = _a[1];
...
qunit_1.test("match: at non-zero offset", function (assert) {
    var input = hbs_parser_next_1.Snippet.input("hello!!!!", LOGGER);
    var next1 = helpers_1.unwrap(input.invoke(hbs_parser_next_1.combinators.tag("hello"), input))[0];
    var _a = helpers_1.unwrap(next1.invoke(hbs_parser_next_1.combinators.takeWhile("!"), next1)), next = _a[0], match = _a[1];
    helpers_1.eqSnippet(next, input.slice(9).rest);
    helpers_1.eqSnippet(match, input.slice(5).slice(4));
});
qunit_1.test("match: skipping zero characters", function (assert) {
    var input = hbs_parser_next_1.Snippet.input("hello world", LOGGER);
    var _a = helpers_1.unwrap(input.invoke(hbs_parser_next_1.combinators.takeWhile("hello"), input)), next = _a[0], match = _a[1];
    helpers_1.eqSnippet(next, input.slice(5).rest);
    helpers_1.eqSnippet(match, input.slice(5));
});
qunit_1.test("match: skipping until the last characters", function (assert) {
    var input = hbs_parser_next_1.Snippet.input("hello world", LOGGER);
    var _a = helpers_1.unwrap(input.invoke(hbs_parser_next_1.combinators.takeWhile("hello world"), input)), next = _a[0], match = _a[1];
    helpers_1.eqSnippet(next, input.slice(11).rest);
    helpers_1.eqSnippet(match, input.slice(11));
});
qunit_1.test("mismatch: no match before the end", function (assert) {
    var input = hbs_parser_next_1.Snippet.input("hellohello", LOGGER);
    var _a = helpers_1.unwrap(input.invoke(hbs_parser_next_1.combinators.takeWhile("hellohello"), input)), next = _a[0], match = _a[1];
    helpers_1.eqSnippet(next, input.slice(10).rest);
    helpers_1.eqSnippet(match, input.slice(10));
});
...
qunit_1.test("zero times", function (assert) {
    var input = hbs_parser_next_1.Snippet.input("abcabcabc", LOGGER);
    var _a = helpers_1.unwrap(input.invoke(hbs_parser_next_1.multi.many(hbs_parser_next_1.combinators.tag("def")), input)), next = _a[0], match = _a[1];
    helpers_1.eqSnippet(next, input);
    helpers_1.eqSnippets(match, []);
});
qunit_1.test("one time", function (assert) {
    var input = hbs_parser_next_1.Snippet.input("hello world", LOGGER);
    var _a = helpers_1.unwrap(input.invoke(hbs_parser_next_1.multi.many(hbs_parser_next_1.combinators.tag("hello")), input)), next = _a[0], match = _a[1];
    helpers_1.eqSnippet(next, input.slice(5).rest);
    helpers_1.eqSnippets(match, [input.slice(5)]);
});
qunit_1.test("several times", function (assert) {
    var input = hbs_parser_next_1.Snippet.input("abcabcabc", LOGGER);
    var _a = helpers_1.unwrap(input.invoke(hbs_parser_next_1.multi.many(hbs_parser_next_1.combinators.tag("abc")), input)), next = _a[0], match = _a[1];
    helpers_1.eqSnippet(next, input.slice(9).rest);
    helpers_1.eqSnippets(match, [
        input.slice(3),
...
qunit_1.test("zero times", function (assert) {
    var input = hbs_parser_next_1.Snippet.input("abcabcabc", LOGGER);
    var mismatch = input.invoke(hbs_parser_next_1.utils.present(hbs_parser_next_1.multi.many(hbs_parser_next_1.combinators.tag("def"))), input);
    helpers_1.eqError(mismatch, hbs_parser_next_1.err(input, "empty"));
});
qunit_1.test("one time", function (assert) {
    var input = hbs_parser_next_1.Snippet.input("hello world", LOGGER);
    var _a = helpers_1.unwrap(input.invoke(hbs_parser_next_1.utils.present(hbs_parser_next_1.multi.many(hbs_parser_next_1.combinators.tag("hello"))), input)), next = _a[0], match = _a[1];
    helpers_1.eqSnippet(next, input.slice(5).rest);
    helpers_1.eqSnippets(match, [input.slice(5)]);
});
qunit_1.test("several times", function (assert) {
    var input = hbs_parser_next_1.Snippet.input("abcabcabc", LOGGER);
    var _a = helpers_1.unwrap(input.invoke(hbs_parser_next_1.utils.present(hbs_parser_next_1.multi.many(hbs_parser_next_1.combinators.tag("abc"))), input)), next = _a[0], match = _a[1];
    helpers_1.eqSnippet(next, input.slice(9).rest);
    helpers_1.eqSnippets(match, [
        input.slice(3),
        input.slice(3).slice(3),
...
qunit_1.test("simple content", function (assert) {
    assert.tree("hello", hbs_parser_next_1.b.text("hello"));
});
qunit_1.test("a simple tag", function (assert) {
    assert.tree("<div>", hbs_parser_next_1.b.startTag("div"));
});
qunit_1.test("A simple tag with trailing spaces", function (assert) {
    assert.tree("<div   \t\n>", hbs_parser_next_1.b.startTag({ name: "div", attrs: [hbs_parser_next_1.b.ws("   \t\n")] }));
});
qunit_1.test("A simple closing tag", function (assert) {
    assert.tree("</div>", hbs_parser_next_1.b.endTag("div"));
});
qunit_1.test("A simple closing tag with trailing spaces", function (assert) {
    assert.tree("</div   \t\n>", hbs_parser_next_1.b.endTag({ name: "div", trailing: "   \t\n" }));
});
qunit_1.test("A pair of hyphenated tags", function (assert) {
    assert.tree("<x-foo></x-foo>", hbs_parser_next_1.b.startTag("x-foo"), hbs_parser_next_1.b.endTag("x-foo"));
});
qunit_1.test("A tag with a single-quoted attribute", function (assert) {
...
qunit_1.test("A tag with a double-quoted attribute", function (assert) {
    assert.tree("<div id=\"foo\">", hbs_parser_next_1.b.startTag({
        name: "div",
        attrs: [hbs_parser_next_1.b.sp, hbs_parser_next_1.b.attr({ name: "id", value: "\"foo\"" })]
    }));
});
qunit_1.test("A tag with a double-quoted empty", function (assert) {
    assert.tree("<div id=\"\">", hbs_parser_next_1.b.startTag({
        name: "div",
        attrs: [hbs_parser_next_1.b.sp, hbs_parser_next_1.b.attr({ name: "id", value: "\"\"" })]
    }));
});
qunit_1.test("A tag with unquoted attribute", function (assert) {
    assert.tree("<div id=foo>", hbs_parser_next_1.b.startTag({
        name: "div",
        attrs: [hbs_parser_next_1.b.sp, hbs_parser_next_1.b.attr({ name: "id", value: "foo" })]
    }));
});
qunit_1.test("A tag with valueless attributes", function (assert) {
...
qunit_1.test("A tag with multiple attributes", function (assert) {
...
qunit_1.test("A self-closing tag", function (assert) {
...
qunit_1.test("A self-closing tag with valueless attributes", function (assert) {
...
qunit_1.test("A comment", function (assert) {
...
qunit_1.test("content plus interpolation", function (assert) {
...
Object.defineProperty(exports, "__esModule", { value: true });
__webpack_require__(/*! ./interpolation */ "./tests/reader/interpolation.ts");
...
qunit_1.assert.tree = function (source) {
    ...
    this.step(step);
    var tree = hbs_parser_next_1.read(source, { logging: qunit_1.config.logging });
...
/******/ });
//# sourceMappingURL=data:application/json;charset=utf-8;base64,