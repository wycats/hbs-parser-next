...
export declare type UnionResult<T extends ReadonlyArray<ParserArrow<void, ParseResult<any>>>> = {
    [P in keyof T]: P extends number ? T[P] extends ParserArrow<any, ParseResult<infer R>> ? R : never : never;
}[number];
